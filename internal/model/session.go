...
type Session struct {
	...
	ReceiveId     string         `gorm:"column:receive_id;Index;type:char(20);not null;comment:接收会话人id"`
	...
	LastMessageAt sql.NullTime   `gorm:"column:last_message_at;type:datetime;comment:最新接收时间"`
